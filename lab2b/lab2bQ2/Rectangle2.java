...
// Changes			: Implements the getArea and getPerimeter methods.
...
public class Rectangle2
{
    ...
    public Rectangle2(int theLength, int theWidth) // Second constructor which takes (roomNumber, roomType, occupied, rate)
    {
        setLength(theLength);
        setWidth(theWidth);
