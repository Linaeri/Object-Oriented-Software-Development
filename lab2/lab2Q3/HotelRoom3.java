...
// Changes          : Implement a second constructor method
...
public class HotelRoom3
{
    ...
    public HotelRoom3() // constructor (takes no arguments)
    {

    }

    public HotelRoom3(int roomNum, String type, int vacancy, double rate) // Second constructor which takes (roomNumber, roomType, occupied, rate)
    {
        setRoomNumber(roomNum);
        setRoomType(type);
        setRoomVacancy(vacancy);
        setRoomRate(rate);
    }
